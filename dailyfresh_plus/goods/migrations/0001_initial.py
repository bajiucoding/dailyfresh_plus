# Generated by Django 2.2.2 on 2019-06-13 08:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, max_digits=7, max_length=10, verbose_name='商品价格')),
                ...
                ('goods', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.GoodsInfo', verbose_name='商品SPU')),
            ],
            options={
                'verbose_name': '商品SKU',
