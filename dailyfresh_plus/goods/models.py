...
class GoodsSKU(models.Model):
    ...
    goods = models.ForeignKey('GoodsInfo',verbose_name='商品SPU',on_delete=models.CASCADE)
    name = models.CharField(max_length=20,verbose_name='商品名称')
    desc = models.CharField(max_length=256,verbose_name='商品简介')
    price = models.DecimalField(max_length=10,max_digits=7,decimal_places=2,verbose_name='商品价格') #两位小数
...
class IndexGoodsBanner(models.Model):
    ...
    image =models.ImageField(upload_to='banner',verbose_name='首页图片')
