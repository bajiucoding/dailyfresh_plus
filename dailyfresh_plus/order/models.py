...
class OrderInfo(models.Model):
    ...
    address = models.ForeignKey('user.AddressInfo',verbose_name='地址',on_delete=models.CASCADE)
    pay_method = models.SmallIntegerField(choices=PAY_METHOD_CHOICES, default=3, verbose_name='支付方式')
    total_count = models.IntegerField(default=1, verbose_name='商品数量')
    total_amount = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='商品总价')
    transit_amount = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='订单运费')
...
class OrderGoods(models.Model):
    ...
    good = models.ForeignKey('goods.GoodsSKU', verbose_name='商品SKU',on_delete=models.CASCADE)
